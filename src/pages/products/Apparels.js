...
<div className='font-[manrope] text-[#256795] text-[25px] leading-[120%] tracking-[0.5px] mx-auto w-full text-center my-5'>Apparel Section</div>
...
<div className="h-[220px] bg-[#497383] rounded-[24px] mx-auto w-[90%] md:w-[75%] py-8"></div>
