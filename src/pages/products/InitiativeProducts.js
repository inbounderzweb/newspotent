...
<div className='font-[manrope] text-[#256795] text-[25px] leading-[120%] tracking-[0.5px] mx-auto w-full text-center my-5'>Our Initiatives</div>
...
<div className="h-[220px] bg-[#915757] rounded-[24px] mx-auto w-[90%] md:w-[75%] py-8"></div>
...
<div className="p-2 bg-white rounded-[8px] flex flex-col h-full">
  <img
    ...
    alt={product.name}
    className="w-full object-cover cursor-pointer rounded-[8px] h-64" // fixed height for images
  />
